  ...
  function (t, e, i) {
    ...
    function a(t, e, i, o, s) {
      THREE.BufferGeometry.call(this),
        ...
        (o = isNaN(o) ? 0.15 : o);
      var n =
          t / 2 - (o = Math.min(o, Math.min(t, Math.min(e, Math.min(i))) / 2)),
        r = e / 2 - o,
        a = i / 2 - o;
      this.parameters = {
        width: t,
      ...
      !(function () {
        for (
          ...
          v.push([]), g.push([]);
        for (
          var i = Math.PI / 2, h = new THREE.Vector3(n, r, a), u = 0;
          u <= s;
          u++
        ) {
          var c = (u / s) * i,
        ...
        (function () {
          for (
            var t = [!0, !1, !0, !1, !1, !0, !1, !0], e = d * (s - 1), i = 0;
            i < 8;
            i++
          ) {
            ...
            for (var w = 0; w < s; w++) {
              var v = o + e + w,
                ...
                y = o + R;
              t[i]
                ? (M.push(v), M.push(y), M.push(g))
                : (M.push(v), M.push(g), M.push(y));
            }
          }
        })(),
        (function () {
      ...
      for (var T = 0, H = 0; H < m.length; H++)
        f.setXYZ(T, m[H].x, m[H].y, m[H].z),
          w.setXYZ(T, E[H].x, E[H].y, E[H].z),
          T++;
      this.setIndex(new THREE.BufferAttribute(new Uint16Array(M), 1)),
    ...
    var h = function t() {
      !(function (t, e) {
        ...
        (this.geom = new a(0.5, 0.5, 0.5, 0.02, 0.2)),
        (this.rotationX = 0),
        (this.rotationY = 0),
        (this.rotationZ = 0);
    };
        ...
        (i = [
          {
            ...
            value: function () {
              (this.gui = new dat.GUI()),
                ...
                (this.repulsion = 1),
                (this.geometries = [new h(), new u(), new r()]),
                this.gui
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.camera = new THREE.PerspectiveCamera(45, t / e, 1)),
          ...
          },
          {
            ...
            value: function () {
              ...
              i.addColor(t, "color").onChange(function (t) {
                ...
                i.add(t, "metalness", 0.1, 1).onChange(function (t) {
                  e.metalness = t;
                }),
                i.add(t, "roughness", 0.1, 1).onChange(function (t) {
                  e.roughness = t;
                });
              for (var o = 0; o < this.grid.rows; o++) {
                ...
                for (var s = 0; s < this.grid.cols; s++) {
                  ...
                  a.position.set(
                    s + s * this.gutter.size,
                    0,
                    o + o * this.gutter.size
                  ),
                    (a.rotation.x = r.rotationX),
                    (a.rotation.y = r.rotationY),
              ...
              var h =
                  ...
                  (this.grid.cols -
                    1 +
                    (this.grid.cols - 1) * this.gutter.size),
                u =
                  0.5 *
                  (this.grid.rows -
                    1 +
                    (this.grid.rows - 1) * this.gutter.size);
              this.groupMesh.position.set(-h, 0, -u),
          ...
          },
          {
            ...
            value: function () {
              var t = new THREE.PlaneGeometry(2e3, 2e3),
                e = new THREE.ShadowMaterial({ opacity: 0.3 });
              (this.floor = new THREE.Mesh(t, e)),
          ...
          },
          {
            ...
            value: function () {
              this.setup(),
                ...
                this.addFloor(),
                this.animate(),
                this.addPointLight(16773120, { x: 0, y: 10, z: -100 }),
                this.addPointLight(16773120, { x: 100, y: 10, z: 0 }),
                this.addPointLight(65280, { x: 20, y: 5, z: 20 });
            },
          },
          {
            key: "onMouseMove",
            value: function (t) {
              var e = t.clientX,
                i = t.clientY;
              (this.mouse3D.x = (e / this.width) * 2 - 1),
                (this.mouse3D.y = (-i / this.height) * 2 + 1);
            },
          },
          {
            key: "onResize",
          ...
          },
          {
            ...
            value: function () {
              ...
              var t,
                ...
                i,
                n,
                r = this.raycaster.intersectObjects([this.floor]);
              if (r.length)
                for (
                  var a = r[0].point, h = a.x, u = a.z, c = 0;
                  c < this.grid.rows;
                  c++
                )
                  for (var p = 0; p < this.grid.cols; p++) {
                    var d = this.meshes[c][p],
                      l =
                        ((t = h),
                        (e = u),
                        (i = d.position.x + this.groupMesh.position.x),
                        (n = d.position.z + this.groupMesh.position.z),
                        Math.sqrt(Math.pow(t - i, 2) + Math.pow(e - n, 2))),
                      f = s(l, 6, 0, 0, 10);
                    TweenMax.to(d.position, 0.2, { y: f < 1 ? 1 : f });
                    var w = d.position.y / 2.5,
                      v = w < 1 ? 1 : w;
                    TweenMax.to(d.scale, 0.4, {
                      ease: Expo.easeOut,
                      x: v,
                      y: v,
                      z: v,
                    }),
                      TweenMax.to(d.rotation, 0.5, {
                        ease: Expo.easeOut,
